...
import {addItemCount,  removeItemCount, removeItem} from '../../redux/Slices/cartSlice';

import { useDispatch } from 'react-redux';

const CartItem = (item, id, title, imageUrl, price, count, type) => {
